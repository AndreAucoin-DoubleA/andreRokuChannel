...
function getMoviePaths(baseUrl as string, apiKey as string) as object
    return [
        ...
        { title: "Movie - Popular", path: baseUrl + "/movie/popular?api_key=" + apiKey + "&page=2" }
        { title: "Movie - Top Rated", path: baseUrl + "/movie/top_rated?api_key=" + apiKey + "&page=2" }
        { title: "Movie - Now Playing", path: baseUrl + "/movie/now_playing?api_key=" + apiKey + "&page=2" }
        { title: "Movie - Upcoming", path: baseUrl + "/movie/upcoming?api_key=" + apiKey + "&page=2" }
        { title: "Movie - Action", path: baseUrl + "/discover/movie?with_genres=28&api_key=" + apiKey + "&page=2" },
        { title: "Movie - Adventure", path: baseUrl + "/discover/movie?with_genres=12&api_key=" + apiKey + "&page=2" },
        { title: "Movie - Animation", path: baseUrl + "/discover/movie?with_genres=16&api_key=" + apiKey + "&page=2" },
        { title: "Movie - Comedy", path: baseUrl + "/discover/movie?with_genres=35&api_key=" + apiKey + "&page=2" },
        { title: "Movie - Crime", path: baseUrl + "/discover/movie?with_genres=80&api_key=" + apiKey + "&page=2" },
        { title: "Movie - Documentary", path: baseUrl + "/discover/movie?with_genres=99&api_key=" + apiKey + "&page=2" },
        { title: "Movie - Drama", path: baseUrl + "/discover/movie?with_genres=18&api_key=" + apiKey + "&page=2" },
        { title: "Movie - Family", path: baseUrl + "/discover/movie?with_genres=10751&api_key=" + apiKey + "&page=2" },
        { title: "Movie - Fantasy", path: baseUrl + "/discover/movie?with_genres=14&api_key=" + apiKey + "&page=2" },
        { title: "Movie - History", path: baseUrl + "/discover/movie?with_genres=36&api_key=" + apiKey + "&page=2" },
        { title: "Movie - Horror", path: baseUrl + "/discover/movie?with_genres=27&api_key=" + apiKey + "&page=2" },
        { title: "Movie - Music", path: baseUrl + "/discover/movie?with_genres=10402&api_key=" + apiKey + "&page=2" },
        { title: "Movie - Mystery", path: baseUrl + "/discover/movie?with_genres=9648&api_key=" + apiKey + "&page=2" },
        { title: "Movie - Romance", path: baseUrl + "/discover/movie?with_genres=10749&api_key=" + apiKey + "&page=2" },
        { title: "Movie - Science Fiction", path: baseUrl + "/discover/movie?with_genres=878&api_key=" + apiKey + "&page=2" },
        { title: "Movie - TV Movie", path: baseUrl + "/discover/movie?with_genres=10770&api_key=" + apiKey + "&page=2" },
        { title: "Movie - Thriller", path: baseUrl + "/discover/movie?with_genres=53&api_key=" + apiKey + "&page=2" },
        { title: "Movie - War", path: baseUrl + "/discover/movie?with_genres=10752&api_key=" + apiKey + "&page=2" },
        { title: "Movie - Western", path: baseUrl + "/discover/movie?with_genres=37&api_key=" + apiKey + "&page=2" },
    ]
end function
